...
## Corpus Check
- 53 files · ~293,382 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 179 nodes · 230 edges · 19 communities detected
...
Cohesion: 0.05
Nodes (7): continueFromResume(), onVisibility(), poll(), prepareApplication(), retryPreparation(), saveResume(), tick()

### Community 1 - "Community 1"
Cohesion: 0.13
Nodes (13): api(), ApiError, clearSession(), completeOnboarding(), getApplicationProfile(), getOnboardingState(), getProductMeta(), getTargeting() (+5 more)
