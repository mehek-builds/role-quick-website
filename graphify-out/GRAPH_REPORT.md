...
## Corpus Check
- 60 files · ~302,380 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 213 nodes · 282 edges · 31 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `api()` - 15 edges
2. `setVerifiedPassword()` - 5 edges
3. `restart()` - 5 edges
4. `periodsFor()` - 5 edges
5. `continueFromResume()` - 4 edges
6. `landingRoute()` - 4 edges
7. `submitCredentials()` - 4 edges
8. `degrade()` - 4 edges
9. `tick()` - 3 edges
10. `prepareApplication()` - 3 edges
...
Cohesion: 0.32
Nodes (8): enterPasswordRecovery(), landingRoute(), passwordProblem(), requestCode(), setVerifiedPassword(), submitCode(), submitCredentials(), submitNewPassword()
...
- **Thin community `Community 20`** (2 nodes): `google-session.ts`, `completeGoogleSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (2 nodes): `billing.ts`, `isLemonSqueezyCheckoutUrl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 23`** (2 nodes): `CinematicPage.tsx`, `CinematicPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `Wash.tsx`, `Wash()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (2 nodes): `SmoothScroll.tsx`, `SmoothScroll()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (2 nodes): `jobParams()`, `loadMore()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
