...
5. `landingRoute()` - 4 edges
6. `submitCredentials()` - 4 edges
7. `setVerifiedPassword()` - 4 edges
8. `degrade()` - 4 edges
9. `tick()` - 3 edges
...
Cohesion: 0.38
Nodes (7): landingRoute(), passwordProblem(), requestCode(), setVerifiedPassword(), submitCode(), submitCredentials(), submitNewPassword()
