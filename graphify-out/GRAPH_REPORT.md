...
## Corpus Check
- 59 files · ~299,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 198 nodes · 259 edges · 31 communities detected
...
- **Thin community `Community 19`** (2 nodes): `landingRoute()`, `submitCode()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (2 nodes): `google-session.ts`, `completeGoogleSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (2 nodes): `requestCode()`, `submitEmail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
