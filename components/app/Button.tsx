...
const BASE =
  "inline-flex min-h-11 min-w-0 max-w-full items-center justify-center gap-2 whitespace-normal rounded-full text-center font-medium [overflow-wrap:anywhere] transition-[background-color,border-color,opacity,color,box-shadow,transform,scale] active:scale-[0.985] motion-reduce:transform-none motion-reduce:active:scale-100 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100 aria-disabled:cursor-not-allowed aria-disabled:opacity-50";
