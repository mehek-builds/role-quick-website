    ...
    >
      <div className="rq-glass mx-auto flex max-w-5xl items-center justify-between rounded-full py-2 pl-4 pr-2">
        ...
        <div className="flex items-center gap-2">
          <a href="/login" className="hidden min-h-11 items-center px-2 text-sm text-muted transition-colors hover:text-ink lg:inline-flex">Log in</a>
      ...
      {menuOpen && (
        ...
        >
          ...
          <a href="/login" onClick={() => closeMenu()} className="block rounded-card px-4 py-3 text-base font-medium text-ink transition-colors hover:bg-white/70">Log in</a>
        </nav>
      )}
    </header>
  );
