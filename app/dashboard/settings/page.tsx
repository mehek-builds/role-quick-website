      ...
      {activeTab === "plan" && <section className="space-y-4" id="panel-plan">
        ...
        {paidPlan ? (
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-4 rounded-inner border border-brand/25 bg-brand-soft px-5 py-4">
            <p className="max-w-xl text-sm text-muted"><span className="font-medium text-ink">Application filling stays free. </span>Choose Litos+ for new tailoring, job insights, and sending without being asked each time.</p>
