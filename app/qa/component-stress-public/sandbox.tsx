...
const ROUTE_SCENARIOS = [
  ...
  { id: "pricing-loading", label: "Extension checkout loading", path: "/pricing?surface=extension", width: 320 },
  { id: "pricing-error", label: "Extension checkout catalog error", path: "/pricing?surface=extension", width: 640 },
  { id: "pricing-checkout", label: "Extension checkout states", path: "/pricing?surface=extension", width: 1024 },
